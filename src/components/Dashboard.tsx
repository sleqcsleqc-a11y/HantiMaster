            ...
            {activities.length > 0 ? (
              activities.map((activity, index) => (
                <button 
                  ...
                  className="w-full flex items-center gap-4 p-4 bg-violet-50/20 dark:bg-zinc-800/30 border border-violet-50 dark:border-zinc-800 rounded-2xl group hover:border-violet-300 dark:hover:border-violet-500 hover:bg-white dark:hover:bg-zinc-800 transition-all duration-300 text-left"
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-bold text-zinc-900 dark:text-white group-hover:text-violet-700 dark:group-hover:text-violet-400 transition-colors">{activity.action}</p>
                    <p className="text-[10px] text-zinc-500 dark:text-zinc-400 uppercase tracking-widest font-medium">
              ...
              <div className="py-12 text-center">
                <p className="text-zinc-500 dark:text-zinc-400 text-xs font-bold uppercase tracking-widest">No recent activity detected</p>
              </div>
            )}
          </div>
        </div>
