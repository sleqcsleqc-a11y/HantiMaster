      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="vintsy-card p-8 space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
              <div>
                <p className="text-sm font-bold text-zinc-900">Minimum Length</p>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Characters required</p>
              </div>
              <input 
                type="number" 
                defaultValue={rules?.password_policy?.min_length} 
                className="w-16 px-3 py-2 bg-white border border-zinc-200 rounded-xl text-sm font-bold text-center focus:outline-none focus:ring-2 focus:ring-violet-500/20"
              />
            </div>
            <div className="flex items-center justify-between p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
              <div>
                <p className="text-sm font-bold text-zinc-900">Complexity Requirements</p>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Special chars, numbers, uppercase</p>
              </div>
              <select defaultValue="High" className="px-4 py-2 bg-white border border-zinc-200 rounded-xl text-xs font-bold focus:outline-none focus:ring-2 focus:ring-violet-500/20">
                <option>Low</option>
                <option>High</option>
            ...
            <div className="flex items-center justify-between p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
              <div>
                <p className="text-sm font-bold text-zinc-900">Rotation Period</p>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Days before forced reset</p>
              </div>
              <div className="flex items-center gap-3">
                <input 
                  type="number" 
                  defaultValue={rules?.password_policy?.rotation_days} 
                  className="w-20 px-3 py-2 bg-white border border-zinc-200 rounded-xl text-sm font-bold text-center focus:outline-none focus:ring-2 focus:ring-violet-500/20"
                />
        ...
        <div className="vintsy-card p-8 space-y-8">
          ...
          <div className="space-y-6">
            <div className="p-4 bg-violet-50 border border-violet-100 rounded-2xl space-y-4">
              <div className="flex items-center justify-between">
                <p className="text-sm font-bold text-violet-900 uppercase tracking-widest">Enforced Roles</p>
              ...
              <div className="flex flex-wrap gap-2">
                {rules?.mfa_settings?.enforced_roles?.map((role: string) => (
                  <span key={role} className="px-3 py-1 bg-white rounded-lg text-[10px] font-bold uppercase tracking-widest text-violet-700 border border-violet-100 shadow-sm">
                    {role}
                  </span>
                ))}
              </div>
            ...
            <div className="p-4 bg-zinc-50 border border-zinc-100 rounded-2xl space-y-4">
              <div className="flex items-center justify-between">
                <p className="text-sm font-bold text-zinc-900 uppercase tracking-widest">Optional Roles</p>
              ...
              <div className="flex flex-wrap gap-2">
                {rules?.mfa_settings?.optional_roles?.map((role: string) => (
                  <span key={role} className="px-3 py-1 bg-white rounded-lg text-[10px] font-bold uppercase tracking-widest text-zinc-500 border border-zinc-100 shadow-sm">
                    {role}
                  </span>
                ))}
              </div>
        ...
        <div className="vintsy-card p-8 space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
              <div>
                <p className="text-sm font-bold text-zinc-900">Session Timeout</p>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Inactivity period</p>
              </div>
              <div className="flex items-center gap-3">
                <input 
                  type="number" 
            ...
            <div className="flex items-center justify-between p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
              <div>
                <p className="text-sm font-bold text-zinc-900">Auto-Logout</p>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Force logout on timeout</p>
              </div>
        ...
        <div className="vintsy-card p-8 space-y-8 lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Add New Rule Form */}
            <div className="md:col-span-1 space-y-6 p-6 bg-zinc-50 rounded-3xl border border-zinc-100">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full px-4 py-2 bg-white border border-zinc-200 rounded-xl text-xs font-bold focus:outline-none focus:ring-2 focus:ring-violet-500/20"
                  >
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-2 bg-white border border-zinc-200 rounded-xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-violet-500/20 h-20 resize-none"
                  />
                </div>
              ...
              <div className="space-y-3">
                {rules?.hierarchy_rules?.length === 0 ? (
                  ...
                  rules?.hierarchy_rules?.map((rule: any) => (
                    <div key={rule.id} className="flex items-center justify-between p-5 bg-white border border-zinc-100 rounded-2xl group hover:border-violet-200 transition-all shadow-sm">
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <div className="flex items-center gap-3 mb-1">
                            <span className="text-sm font-bold text-zinc-900">{rule.role_a_name}</span>
                            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
                              {rule.type === 'Inheritance' ? 'Inherits' : 'Restricted With'}
                            </span>
                            <span className="text-sm font-bold text-zinc-900">{rule.role_b_name}</span>
                          </div>
                      ...
                      <button 
                        ...
                        className="p-2.5 text-zinc-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all opacity-0 group-hover:opacity-100"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
