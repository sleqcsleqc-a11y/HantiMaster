      ...
      >
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-bold text-zinc-900">Request Access</h3>
          </div>
        ...
        {success ? (
          <div className="text-center py-8">
            ...
            <h4 className="text-lg font-bold text-zinc-900 mb-2">Request Submitted</h4>
            <p className="text-sm text-zinc-500">Your request has been sent to the administrator for review.</p>
          </div>
        ) : (
